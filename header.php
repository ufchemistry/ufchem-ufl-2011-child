...
<body <?php body_class(); ?>>
  ...
  <?php
   ...
   ?>
	...
	<header role="banner">
	  <div class="container">
          <a href="https://www.chem.ufl.edu/"><img class="chemlogo" src="<?php echo get_stylesheet_directory_uri() . "/library/images/" . ufchem_ufl_2011_get_color_scheme() . "/chem_logo.png"; ?>" /></a>
		...
		<div id="header-search-wrap">
		  ...
		  <div id="searchform-wrap">
			...
			<form method="get" id="searchform" action="<?php echo home_url('/'); ?>" role="search">
				...
				<?php $search_btn_url = ( ufchem_ufl_2011_get_color_scheme() == 'chem2' )? "/library/images/chem2/header-search-btn-orange.jpg":'/images/header-search-btn-orange.jpg'; ?>
                <input type="image" src="<?php echo get_stylesheet_directory_uri() . $search_btn_url; ?>" id="header-search-btn"  alt="Search Button" name="sa" />
			</form>
			<?php } else { ?>
